...
export async function Player1Prefab(gameObject: GameObject) {
    ...
    await gameObject.addComponent(AnimatedSprite, async animatedSprite => {
        ...
        animatedSprite.spriteAnimations['jump left'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerSnow/jump0.png').mirrorX().load!], 200);
        animatedSprite.spriteAnimations['jump right'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerSnow/jump0.png').load!], 200);
        animatedSprite.spriteAnimations['attack left'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerSnow/attack0.png').mirrorX().load!], 200);
        animatedSprite.spriteAnimations['attack right'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerSnow/attack0.png').load!], 200);
