...
export function Player2Prefab(gameObject: GameObject) {
    ...
    gameObject.addComponent(AnimatedSprite, animatedSprite => {
        ...
        animatedSprite.spriteAnimations['run left'] = new SpriteAnimation([new Sprite('Images/Characters/PlayerFire/run0.png').mirrorX(), new Sprite('Images/Characters/PlayerFire/idle0.png')], 200);
