...
export async function Player2Prefab(gameObject: GameObject) {
    ...
    await gameObject.addComponent(AnimatedSprite, async animatedSprite => {
        ...
        animatedSprite.spriteAnimations['jump left'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerFire/jump0.png').mirrorX().load!], 0);
        animatedSprite.spriteAnimations['jump right'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerFire/jump0.png').load!], 0);
        animatedSprite.spriteAnimations['attack left'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerFire/attack0.png').load!], 0);
        animatedSprite.spriteAnimations['attack right'] = new SpriteAnimation([await new Sprite('Images/Characters/PlayerFire/attack0.png').mirrorX().load!], 0);
